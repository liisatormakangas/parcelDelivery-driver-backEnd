...
INSERT INTO `parcel`
  (`id_user`, `reciever_name`, `reciever_telephone`, `reciever_street_address`, `reciever_postal_code`, `reciever_city`,
   `sender_name`, `sender_telephone`, `sender_street_address`, `sender_postal_code`, `sender_city`, `receiver_email`,
...
VALUES
  (1, 'John Smith', '0405678456', 'Yliopistokatu 10B 123', '900', 'Oulu',
   'James Smith', '0403700897', 'Yliopistokatu 10B 456', '900', 'Oulu', 'shehara1991@gmail.com',
   NULL, NULL, NULL,
   1234, 'ready_to_deliver', 3, 1, NULL,
   0.5, 0.5, 0.5, 0.5),
  (2, 'Robert Smith', '040678231', 'Yliopistokatu 10B 789', '570', 'Oulu', 'shehara1991@gmail.com',
   'John Smith', '0401234567', 'Yliopistokatu 10B 1011', '900', 'Oulu',
   NULL, NULL, NULL,
   4567, 'parcel_in_pickup_locker', 1, 2, NULL,
   0.5, 0.5, 0.5, 0.5),
  (3, 'Michael Smith', '0401234567', 'Yliopistokatu 10B 1011', '570', 'Oulu', 'shehara1991@gmail.com',
   'Robert Smith', '040678231', 'Yliopistokatu 10B 789', '70', 'Oulu',
   NULL, NULL, NULL,
   NULL, 'parcel_at_dropoff_locker', 1, 3, NULL,
   0.5, 0.5, 0.5, 0.5),
  (4,'Michael Smith', '0401234567','Yliopistokatu 10B 1011', '570', 'Oulu', 'shehara1991@gmail.com',
   'Robert Smith', '040678231', 'Yliopistokatu 10B 789', '90', 'Oulu',
   NULL, NULL, NULL,
   NULL, 'parcel_in_transportation', 2, 1, NULL,
   0.5, 0.5, 0.5, 0.5);
